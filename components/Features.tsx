...
const Features = () => {
  ...
  const features = [
    ...
    {
      title: "Visual Study",
      message: "LEARN THROUGH VISUALS",
      description: "Concept-based visual learning using animations, mind maps, infographics, and graphs, helping students understand faster without reading long text.", 
      icon: "🎥",
      link: "/visuale",
      color: "#20B2AA",
      hoverColor: "#30d2ca",
