...
const Features = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      message: "THIS IS SPEECH FLUENCY",
      description: "Interactive speech therapy tools with pronunciation guides, fluency exercises, and progress tracking to build confident communication skills.",
      icon: "🗣️",
      link: "/speech",
      color: "#20B2AA",
      hoverColor: "#30d2ca",
